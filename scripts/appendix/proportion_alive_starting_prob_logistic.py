...
p_list = np.logspace(start=-8, stop=0, num=100, base=10)
width = 256
...
for p in tqdm(p_list):
    model = Logistic(width, alive_prop=p)
    model.run(1000)
...
plt.legend()
plt.savefig("appendix_results/proportion_alive_over_iter_finegrained.png", dpi=300)
...
plt.ylabel("Proportion of Alive Cells")
plt.savefig("appendix_results/proportion_alive_on_probability_finegrained.png", dpi=300)
...
fig.savefig("appendix_results/iters_till_eq_finegrained.png", dpi=300)
